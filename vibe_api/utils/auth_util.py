...
from vibe_api.constants import JWT_SECRET, JWT_ISSUER, PROVIDERS,\
    ACCESS_TOKEN_TTL_SEC, REFRESH_TOKEN_TTL_SEC, InternalErrorCode
...
def verify_id_token_with_jwks(provider_key: str, id_token: str, audience: str) -> Dict[str, Any]:
