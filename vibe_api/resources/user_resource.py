...
from vibe_api.utils.auth_util import issue_access_token, issue_refresh_token, require_auth, verify_dpop
...
class UserResource(Resource):
    ...
    def post(self):
        ...
        refresh_token, refresh_token_expires_at = issue_refresh_token(sub=user.provider_sub)
